...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Văn Hướng - Trường PTDTBTTH Thắng Mố- SĐT: 0976426127</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 -  Nguyễn Văn Hướng - Trường PTDTBTTH Thắng Mố- 0976426127</div>", unsafe_allow_html=True)
